 ...
 */
public class DNAScorer implements Scorer,Serializable
{	
	/**
	 * 
	 */
	private static final long serialVersionUID = 6635930693051868348L;
	...
	public float compareSequences(Sequence seq1, Sequence seq2)
	{
		...
		for (int i=0;i<seq1.getSize()&&i<seq2.getSize();i++)
		{
