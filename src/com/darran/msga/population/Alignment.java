 ...
 */
public class Alignment extends Individual implements Cloneable, Iterable<Sequence>,Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -2265029641894316438L;
	...
	public Alignment(String[] merged) {
		this();
		for(String seq : merged){
			i_sequences.add(new Sequence(seq));
		}
	}
	...
	public String[] getSequences(){
		String[] sequences = new String[getSize()];
		int i = 0;
		for(Sequence s : i_sequences){
			String temp = s.getSubSequence(0, s.getSize()-1);
			sequences[i] = temp;
			i++;
		}
		return sequences;
